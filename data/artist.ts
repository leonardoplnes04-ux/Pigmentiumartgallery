...
export const artist: Artist = {
  name: "Segundo Planes",
  tagline: "Pintura y color como lenguaje de lo cotidiano.",
  shortBio:
    "Segundo Planes es un artista plástico cuya obra explora la memoria y el paisaje doméstico a través del color y la textura.",
  longBio:
